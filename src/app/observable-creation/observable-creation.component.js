...
var ObservableCreationComponent = (function () {
    function ObservableCreationComponent() {
    }
    ObservableCreationComponent.prototype.ngOnInit = function () {
        this.promise();
        // this.defer();
        // this.of();
        // this.range();
    ...
    ObservableCreationComponent.prototype.promise = function () {
    ...
    ObservableCreationComponent.prototype.defer = function () {
        var i = 0;
    ...
    // Observable from of
    ObservableCreationComponent.prototype.of = function () {
        var source$ = Rx_1.Observable.of(45, 'Hello', [2, 3, 4, 5]).subscribe(this.getSubscriber('of'));
    };
    // Observable from range
    ObservableCreationComponent.prototype.range = function () {
    ...
    ObservableCreationComponent.prototype.timer = function () {
    ...
    ObservableCreationComponent.prototype.interval = function () {
    ...
    ObservableCreationComponent.prototype.hot = function () {
        var self = this;
    ...
    ObservableCreationComponent.prototype.hotAndCold = function () {
    ...
    ObservableCreationComponent.prototype.fromScratch = function () {
    ...
    ObservableCreationComponent.prototype.fromString = function () {
        var str = 'Hello world';
        Rx_1.Observable.from(str).subscribe(this.getSubscriber('string'));
    };
    // Observable from map
    ObservableCreationComponent.prototype.fromMap = function () {
        var m = new Map([[1, 2], [3, 4], [5, 6]]);
        Rx_1.Observable.from(m).subscribe(this.getSubscriber('map'));
    };
    // Observable from Set
    ObservableCreationComponent.prototype.fromSet = function () {
    ...
    ObservableCreationComponent.prototype.fromArrayObjects = function () {
        var users = [
    ...
    ObservableCreationComponent.prototype.fromArray = function () {
        var nums = [33, 45, 23, 4, 5];
        var nums$ = Rx_1.Observable.from(nums);
        nums$.subscribe(this.getSubscriber('nums'));
    };
    ObservableCreationComponent.prototype.getSubscriber = function (id) {
        return {
            next: function (x) {
                console.log(id + ": " + x);
            },
    ...
    return ObservableCreationComponent;
}());
ObservableCreationComponent = __decorate([
    core_1.Component({
        moduleId: module.id,
...
exports.ObservableCreationComponent = ObservableCreationComponent;
//# sourceMappingURL=observable-creation.component.js.map